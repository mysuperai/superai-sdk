    ...
    def __add_basic_workflow(self):
        ...
        if not exists and self.add_basic_workflow:
            ...
            def _basic(*args, **kwargs):
                log.info(f"{self.name}._basic:Arguments: *args: {args}, **kwargs: {kwargs} ")
                log.info(f"{self.name}._basic:inputSchema: {self.__template_object.get('inputSchema')}")
                log.info(f"{self.name}._basic:outputSchema: {self.__template_object.get('outputSchema')}")
                log.info(f"{self.name}._basic:appParamsSchema: {self.__template_object.get('appParamsSchema')}")
                """
