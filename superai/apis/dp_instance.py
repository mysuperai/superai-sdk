...
class DataProgramInstance(DataProgramBase):
    def __init__(self, template_id: str, quality=None, cost=None, latency=None, name=None, description=None, **kwargs):
        ...
        self.__instance_object = self.__create_instance(parameters=kwargs, performance={
            "quality": quality,
            "cost": cost,
            "latency": latency
    ...
    def __create_instance(self, parameters: Dict=None, performance: Dict=None, name: str = None, description: str = None) -> Dict:
        """
        ...
        uri = f'template/{self.template_id}/instance'
